({
    ...
    calcTotalHpr : function(component, event, helper) {
        ...
        for(var i=0;i<marksList.length;i++){
            var iam = marksList[i];
            var theory = (iam.iaMark.Theory_Secured_Marks__c != undefined && iam.iaMark.Theory_Secured_Marks__c != '' && iam.iaMark.Theory_Secured_Marks__c != null) ? iam.iaMark.Theory_Secured_Marks__c : 0;
            var seminar = (iam.iaMark.Seminar_Secured_Marks__c != undefined && iam.iaMark.Seminar_Secured_Marks__c != '' && iam.iaMark.Seminar_Secured_Marks__c != null) ? iam.iaMark.Seminar_Secured_Marks__c : 0;
            var quiz = (iam.iaMark.Quiz_Secured_marks__c != undefined && iam.iaMark.Quiz_Secured_marks__c != '' && iam.iaMark.Quiz_Secured_marks__c != null) ? iam.iaMark.Quiz_Secured_marks__c : 0;
